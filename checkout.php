...
if(isset($_POST['order_btn'])){
   ...
   $total_product = implode(',',(array)$product_name);
      ...
      <span class="grand-total"> grand total : $<?= $grand_total; ?>/- </span>
        ...
        <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" placeholder="e.g. Tom mboya" name="street" required>
         </div>
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="e.g. Kisumu" name="city" required>
         </div>
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.g. Kenya" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
         ...
         <div class="inputBox">
            <span>pin code</span>
            <input type="text" placeholder="e.g. 456789" name="pin_code" required>
         </div>
      </div>
